namespace DAL.Migrations
{
    ...
    public partial class Book_v1 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BookDebts", "PublisherID", "dbo.Publishers");
            DropForeignKey("dbo.BookDebts", "BookID", "dbo.Books");
            ...
            DropIndex("dbo.BookDebts", new[] { "BookID" });
            DropIndex("dbo.BookDebts", new[] { "PublisherID" });
